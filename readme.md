...
- `smmparser` contains code that parses the sequence of tokens from lexer and bulds Abstract Syntax Tree (AST) doing some validations on the way
...
2.  You add handling of if statement to smmastwritter.c under processStatement function so it writes relevent data.
